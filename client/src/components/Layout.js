    ...
    <div className="app-layout">
      <header className="app-header slide-down">
        <div className="brand">
          ...
          <div>
            <h1 className="brand-title">visiontechie</h1>
            <p className="nav-subtitle">User Management</p>
          </div>
        </div>
      </header>
      <AnimatedBanner message="Welcome to visiontechie 🚀" />
      <div className="app-body">
        <aside className="sidebar slide-in-left">
          <h3>Connect</h3>
          <ul className="social-links">
            <li><a className="sidebar-btn" href="https://www.linkedin.com/in/harshaldhangar/" target="_blank" rel="noopener noreferrer">LinkedIn</a></li>
      ...
      <footer className="app-footer">
        <p>&copy; {new Date().getFullYear()} visiontechie. All rights reserved.</p>
      </footer>
